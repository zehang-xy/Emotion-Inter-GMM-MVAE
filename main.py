...
def args_define():
    ...
    parser.add_argument('--mvae-epochs', type=int, default=60, metavar='N', help='No of epochs of mvae [default: 10]')
    parser.add_argument('--mh-epochs', type=int, default=60, metavar='N', help='No of epochs of MH naming game [default: 10]')
