...
class Agent:
    def __init__(self, name, args, channel):
        ...
        self.z_logvars = None
        self.true_label = np.load('dataset/emotion_labels.npy')
    ...
    def initialize(self):
        self.dataloader = dataloader.get_modalities(batch_size=self.args.batch_size, shuffle=False, agent=self.name, _vision=True, _audio=True, _interoception=False)
